...
namespace pdm::scoper {
    ...
    char const* frame_kind_as_text(FrameKind frame_kind) {
        switch (frame_kind)
        {
            ...
            case FrameKind::FnRhs: return "FnRhs";
            case FrameKind::TypeRhs: return "TypeRhs";
            case FrameKind::EnumRhs: return "EnumRhs";
            case FrameKind::TypeclassRhs: return "TypeclassRhs";
    ...
    void Frame::print(printer::Printer& p) const {
        ...
        p.print_cstr(" at ");
        p.print_uint(reinterpret_cast<u64>(this), ast::IntExp::Base::Hex);
        p.print_cstr(" {");
        p.print_newline_indent();
        {
            ...
            p.print_uint(m_child_frames.size(), ast::IntExp::Base::Dec);
            p.print_cstr(") ...");
