...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    KW_OR = 280,                   // "or"
    KW_NOT = 281,                  // "not"
    KW_TYPECLASS = 282,            // "typeclass"
    KW_OUT = 283,                  // "out"
    KW_INOUT = 284,                // "inout"
    KW_DISCARD = 285,              // "discard"
    DINT_LIT = 286,                // "42"
    XINT_LIT = 287,                // "0x2a"
    FLOAT_LIT = 288,               // "4.2"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_KW_OR = 25,                            // "or"
        S_KW_NOT = 26,                           // "not"
        S_KW_TYPECLASS = 27,                     // "typeclass"
        S_KW_OUT = 28,                           // "out"
        S_KW_INOUT = 29,                         // "inout"
        S_KW_DISCARD = 30,                       // "discard"
        S_DINT_LIT = 31,                         // "42"
        S_XINT_LIT = 32,                         // "0x2a"
        S_FLOAT_LIT = 33,                        // "4.2"
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 625,     ///< Last index in yytable_.
