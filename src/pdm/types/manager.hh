...
namespace pdm::types {
    ...
    class Manager {
      ...
      public:
        ...
        // TemplateVar_RetValue* new_value_template_var(std::string&& name, ast::BaseNode* opt_client_ast_node = nullptr);
        // TemplateVar_RetType*  new_type_template_var(std::string&& name, ast::BaseNode* opt_client_ast_node = nullptr);
        // TemplateVar_RetClass* new_class_template_var(std::string&& name, ast::BaseNode* opt_client_ast_node = nullptr);
